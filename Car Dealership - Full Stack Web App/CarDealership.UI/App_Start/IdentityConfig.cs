...
namespace CarDealership.UI
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<GuildCarsDbContext>()));
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<UserManager<ApplicationUser>>((options, context) =>
                new UserManager<ApplicationUser>(
                    new UserStore<ApplicationUser>(context.Get<GuildCarsDbContext>())));

            app.CreatePerOwinContext<RoleManager<ApplicationRole>>((options, context) =>
                new RoleManager<ApplicationRole>(
                    new RoleStore<ApplicationRole>(context.Get<GuildCarsDbContext>())));
